...
for ROS 2 Humble). Uses the SOLVED assembly so the simulation works even
before students complete the placeholders.
...
def generate_launch_description():
    ...
    world_file = os.path.expanduser(
        "~/.ignition/fuel/fuel.gazebosim.org/arshal/worlds/"
        "simple_colored_warehouse/1/warehouse_world.sdf"
    )
